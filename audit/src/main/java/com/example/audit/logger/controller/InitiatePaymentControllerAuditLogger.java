...
public class InitiatePaymentControllerAuditLogger implements AuditLogger {
    ...
    private Counter paymentAttemptCounter;
    ...
    @PostConstruct
    public void init(){
        paymentAttemptCounter = this.meterRegistry.counter("payment.attempt");
    ...
    public void log(String methodName, Object[] args, Object value, CustomException e, long executionTime) {
        ...
        paymentAttemptCounter.increment(paymentRequest.getAmount());
